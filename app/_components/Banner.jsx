...
const BannerSwiper = () => {
  ...
  return (
    <div className="w-full px-5  ">
      ...
      <div className="text-white flex justify-center items-center bg-[#0158FF]  transition-all duration-300 text-sm font-semibold px-6 py-3 rounded-xl shadow-md hover:shadow-lg cursor-pointer mt-2">
        <Link
          href="/weekly-offers.pdf"
          target="_blank"
          rel="noopener noreferrer"
        >
          Download our flyer collections <FaArrowRight className="inline ml-2" />
        </Link>
      </div>
    </div>
  );
